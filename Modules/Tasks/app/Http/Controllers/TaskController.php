...
class TaskController
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('tasks::index', ['tasks' => $this->tasks->paginate(TaskFiltersData::fromArray($request->all()), $request->user()), 'statuses' => TaskStatus::cases(), 'priorities' => TaskPriority::cases(), 'projects' => $this->tasks->filterProjects($request->user()), 'users' => $this->tasks->filterUsers($request->user())]);
    }
