...
class BacklogController { use AuthorizesRequests; public function __construct(private readonly BacklogQueryService $backlog) {} public function show(TaskReadModelRequest $request, Project $project) { $this->authorize('view',$project); return TaskResource::collection($this->backlog->paginate($project,$request->user(),$request->integer('per_page',25))); } }
