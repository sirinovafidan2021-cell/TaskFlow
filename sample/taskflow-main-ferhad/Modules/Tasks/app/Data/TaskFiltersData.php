...
final readonly class TaskFiltersData
{
    ...
    {
        return new self($data['q'] ?? null, $data['status'] ?? null, $data['priority'] ?? null, isset($data['project_id']) ? (int) $data['project_id'] : null, isset($data['assignee_id']) ? (int) $data['assignee_id'] : null, $data['due_before'] ?? null, $data['sort'] ?? 'created_at', $data['direction'] ?? 'desc');
    }
}
